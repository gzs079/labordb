<div class="d-flex gap-2">
    <!-- Edit Button -->
    <a href="{{ route($controllerName . '.edit', [$id, 'page' => request()->input('page')]) }}" class="btn btn-warning btn-sm" data-bs-toggle="tooltip" title="Szerkesztés">
    ...
    <form action="{{ route($controllerName . '.destroy', $id) }}" method="POST" onsubmit="return confirm('Biztosan törölni szeretné?');" style="display:inline;">
        ...
        <button type="submit" class="btn btn-danger btn-sm" data-bs-toggle="tooltip" title="Törlés">
